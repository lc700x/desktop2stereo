...
class DepthAnything3(nn.Module, PyTorchModelHubMixin):
    ...
    def forward(self, image: torch.Tensor, extrinsics: Optional[torch.Tensor] = None, 
                intrinsics: Optional[torch.Tensor] = None, 
                export_feat_layers: Optional[Sequence[int]] = None, 
                infer_gs: bool = False) -> dict[str, torch.Tensor]:
        """
        ...
        # Default empty export_feat_layers if None
