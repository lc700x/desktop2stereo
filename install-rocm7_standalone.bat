...
%PYTHON_EXE% -m pip install -r requirements-rocm7.txt --no-cache-dir --no-warn-script-location --trusted-host http://mirrors.aliyun.com/pypi/simple/
...
@REM %PYTHON_EXE% -m pip install onnx==1.19.0 --no-cache-dir --no-warn-script-location --trusted-host  http://mirrors.aliyun.com/pypi/simple/
