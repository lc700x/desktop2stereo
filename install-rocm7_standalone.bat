...
%PYTHON_EXE% -m pip install https://ghfast.topgithub.com/lc700x/MIGraphX-Windows/releases/download/v7.14.0a20260615.post.2.0/migraphx-0.1.0+multiarch-cp312-cp312-win_amd64.whl --no-cache-dir
if %errorlevel% neq 0 (
