...
def convert_dpt_checkpoint(model_name, pytorch_dump_folder_path, push_to_hub, verify_logits):
    ...
    model_name_to_repo = {
        ...
        "depth-anything-video-depth-anything-small": "depth-anything/Video-Depth-Anything-Small"
    }
    ...
    state_dict = {key.replace("head.","depth_head."):value for key, value in state_dict.items()}
    # rename keys
    ...
    if verify_logits:
        ...
        elif model_name == "depth-anything-video-depth-anything-small":
            expected_slice = torch.tensor(
                [[2.6745, 2.6206, 2.6566], [2.5814, 2.6133, 2.6266], [2.6156, 2.6136, 2.6301]]
            )
        else:
