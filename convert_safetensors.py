...
#         print(f"Answer was `{txt}` aborting.")
    try:
        convert_file(r"e:\Download\depth-anything-metric-v1\depth_anything_metric_depth_outdoor.pt", r"e:\Download\depth-anything-metric-v1\model.safetensors", discard_names=[])
