...
if __name__ == "__main__":
    ...
    # predict_depth now does the GPU aspect-preserve + patch-align preprocessing
    # and the official normalize() post-processing for metric models, so it is the
    # single source for both SBS and the inspection PNG (near~1, far~0).
