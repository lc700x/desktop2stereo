...
$filesToCopy = @(
    ...
    "install-mps","install-rocm.bash","install-rocm7.bash","install-rocm6_standalone.bat","install-rocm7.bat", "install-rocm7-nightly.bat", "install-rocm7_official_standalone.bat","install-rocm7_standalone.bat","install-rocm7-nightly_standalone.bat","install-zluda_standalone.bat","install-zluda_standalone0.bat",
    ...
    "utils.py","viewer.py", "xrviewer.py", 'LICNESE'
)

# --- Directories to copy (contents only) ---
$dirsToCopy = @("assets","models","rtmp","controllers", "scripts")
