...
$filesToCopy = @(
    ...
    "install-mps","install-rocm.bash","install-rocm6_standalone.bat","install-rocm7.bash","install-rocm7_standalone.bat",
    ...
    "requirements-rocm.txt","requirements-rocm7-linux.txt","requirements-rocm7.txt","requirements.txt",
